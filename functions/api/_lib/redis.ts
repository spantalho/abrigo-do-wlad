...
export function getRedisStore(env?: CloudflareEnv): RedisStore {
  const redisUrl =
...
mockStore.set("hero-dog", {
  ...
  return redisClient ? liveRedis : mockRedis;
}

export const redis = getRedisStore();
export const redisClient = getRedisStore();

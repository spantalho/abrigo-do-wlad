/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/admin/wrangler.jsonc apps/admin/worker-configuration.d.ts` (hash: 1fb574c6be42b31391f1605d8c95149d)
...
interface __BaseEnv_Env {
	...
	ADMIN_ADMINISTRATOR_EMAILS?: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "AUTH_MODE" | "DATA_MODE" | "MEDIA_MODE" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "ADMIN_DEVELOPER_EMAILS" | "ADMIN_ADMINISTRATOR_EMAILS" | "FIREBASE_PROJECT_ID" | "FIREBASE_CLIENT_EMAIL" | "FIREBASE_PRIVATE_KEY" | "MASTER_KEY" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET">> {}
}

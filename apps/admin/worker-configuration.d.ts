/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/admin/wrangler.jsonc apps/admin/worker-configuration.d.ts` (hash: f7168b100df966224285f3dbfae03692)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "ADMIN_DEVELOPER_EMAILS" | "ADMIN_ADMINISTRATOR_EMAILS" | "FIREBASE_PROJECT_ID" | "FIREBASE_CLIENT_EMAIL" | "FIREBASE_PRIVATE_KEY" | "MASTER_KEY" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET">> {}
}

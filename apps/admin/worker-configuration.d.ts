/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/admin/wrangler.jsonc apps/admin/worker-configuration.d.ts` (hash: b759d6ebb03c9fc143bcfb328c68921d)

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/admin/wrangler.jsonc apps/admin/worker-configuration.d.ts` (hash: 7c5fc76609870f0eb0a31b1e613afa77)
